 ...
 * @LastEditors: MackBai
 * @LastEditTime: 2020-03-21 22:36:59
...
export const search = data => musicAPI(`/search?keywords=${data.value}&limit=${data.amount ? data.amount : 30}&offset=${data.offset ? data.offset : 0}`, 'GET')
// 搜索建议
